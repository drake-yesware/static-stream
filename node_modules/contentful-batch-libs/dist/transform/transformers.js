...
function assets(asset) {
  ...
  transformedAsset.fields.file = (0, _collection.reduce)(asset.fields.file, function (newFile, localizedFile, locale) {
...
function locales(locale, destinationLocales) {
  var transformedLocale = (0, _object.pick)(locale, 'code', 'name', 'contentManagementApi', 'contentDeliveryApi', 'fallbackCode', 'optional');
